...
namespace RemainingTimeMeter
{
    ...
    public partial class TimerWindow : Window, IDisposable
    {
        ...
        private void UpdateBarColor()
        {
            ...
            if (this.isPaused)
            {
                this.ProgressBar.Foreground = new SolidColorBrush(Colors.DarkSlateBlue);
            ...
            {
                this.ProgressBar.Foreground = new SolidColorBrush(Colors.Orange);
                this.ProgressBar.BeginAnimation(OpacityProperty, null);
                this.ProgressBar.Opacity = 1.0;
            }
            else
            {
                this.ProgressBar.Foreground = new SolidColorBrush(Colors.Green);
                this.ProgressBar.BeginAnimation(OpacityProperty, null);
                this.ProgressBar.Opacity = 1.0;
            }
        }
